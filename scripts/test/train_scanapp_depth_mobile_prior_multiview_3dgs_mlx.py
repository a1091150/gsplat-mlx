...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("outputs/scanapp_depth_mobile_prior_train"))
...
def main() -> None:
    ...
    summary = {
        "dataset_type": "scanapp_depth_mobile_prior_masked",
    ...
    log(
        "ScanApp mobile-prior masked depth multi-view training ok "
